...
classLabels = { ...
    'Water - No Change', ...
    'Emergent - No Change', ...
    'Other/Forest/Scrub - No Change', ...
    'Emergent to Water', ...
    'Emergent to Non-Water', ...
    'Non-Emergent to Water', ...
    'Change (No Water/Emergent at Start/End)'};

map1_labels = categorical(map1_clean, 1:7, classLabels);
map2_labels = categorical(map2_clean, 1:7, classLabels);

% Now make chart
confusionchart(map1_labels, map2_labels, ...
    'Title', 'Confusion Matrix: CCAP2006to2010 vs OurMaps2006to2010', ...
    'XLabel', 'Predicted (CCAP2006to2010)', ...
    'YLabel', 'Reference (OurMaps2006to2010)', ...
